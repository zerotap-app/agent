...
3. If Android shows a **"Restricted setting"** warning (Android 13+), you need to allow it first:
   - Go to **Settings → Apps → zerotap agent**
   - Tap the **three-dot menu (⋮)** in the top right
   - Tap **Allow restricted settings**
   - Go back and try enabling the Accessibility Service again
4. In Android Settings, find **zerotap agent** and toggle it on
